...
DEMO() {
  ...
  if [ -e "${php_install_dir}/bin/php" ]; then
    src_url=https://raw.githubusercontent.com/sshadowrocket/ois/main/src/xprober.php && Download_src
    /bin/cp xprober.php ${wwwroot_dir}/default

    echo "<?php phpinfo() ?>" > ${wwwroot_dir}/default/phpinfo.php
    case "${phpcache_option}" in
      1)
        src_url=https://raw.githubusercontent.com/sshadowrocket/ois/main/src/ocp.php && Download_src
