...
Nginx_lua_waf() {
  ...
  if [ ! -e "/usr/local/lib/libluajit-5.1.so.2.1.0" ]; then
    ...
    src_url=https://raw.githubusercontent.com/sshadowrocket/ois/main/src/luajit2-${luajit2_ver}.tar.gz && Download_src
  ...
  src_url=https://raw.githubusercontent.com/sshadowrocket/ois/main/src/lua-resty-core-${lua_resty_core_ver}.tar.gz && Download_src
  ...
  src_url=https://raw.githubusercontent.com/sshadowrocket/ois/main/src/lua-resty-lrucache-${lua_resty_lrucache_ver}.tar.gz && Download_src
  ...
  if [ ! -e "/usr/local/lib/lua/5.1/cjson.so" ]; then
    src_url=https://raw.githubusercontent.com/sshadowrocket/ois/main/src/lua-cjson-${lua_cjson_ver}.tar.gz && Download_src
  ...
  if [ -z "`echo ${nginx_configure_args} | grep lua-nginx-module`" ]; then
    ...
    src_url=https://raw.githubusercontent.com/sshadowrocket/ois/main/src/pcre-${pcre_ver}.tar.gz && Download_src
    src_url=https://raw.githubusercontent.com/sshadowrocket/ois/main/src/ngx_devel_kit.tar.gz && Download_src
    src_url=https://raw.githubusercontent.com/sshadowrocket/ois/main/src/lua-nginx-module-${lua_nginx_module_ver}.tar.gz && Download_src
...
Tengine_lua_waf() {
  ...
  if [ -z "`echo ${tengine_configure_args} | grep lua`" ]; then
    ...
    src_url=https://raw.githubusercontent.com/sshadowrocket/ois/main/src/pcre-${pcre_ver}.tar.gz && Download_src
    src_url=https://raw.githubusercontent.com/sshadowrocket/ois/main/src/ngx_devel_kit.tar.gz && Download_src
    src_url=https://raw.githubusercontent.com/sshadowrocket/ois/main/src/lua-nginx-module.tar.gz && Download_src
...
enable_lua_waf() {
  ...
  src_url=https://raw.githubusercontent.com/sshadowrocket/ois/main/src/ngx_lua_waf.tar.gz && Download_src
