...
checkDownload() {
  mirrorLink=https://raw.githubusercontent.com/sshadowrocket/ois/main/src
  ...
  if [ "${apache_flag}" == 'y' ]; then
    ...
    src_url=https://raw.githubusercontent.com/sshadowrocket/ois/main/apache/httpd/nghttp2-${nghttp2_ver}.tar.gz && Download_src
  fi
  ...
  case "${tomcat_option}" in
    1)
      ...
      src_url=https://raw.githubusercontent.com/sshadowrocket/ois/main/apache/tomcat/v${tomcat10_ver}/apache-tomcat-${tomcat10_ver}.tar.gz && Download_src
      ;;
    2)
      echo "Download tomcat 9..."
      src_url=https://raw.githubusercontent.com/sshadowrocket/ois/main/apache/tomcat/v${tomcat9_ver}/apache-tomcat-${tomcat9_ver}.tar.gz && Download_src
      ;;
    3)
      echo "Download tomcat 8..."
      src_url=https://raw.githubusercontent.com/sshadowrocket/ois/main/apache/tomcat/v${tomcat8_ver}/apache-tomcat-${tomcat8_ver}.tar.gz && Download_src
      ;;
    4)
      echo "Download tomcat 7..."
      src_url=https://raw.githubusercontent.com/sshadowrocket/ois/main/apache/tomcat/v${tomcat7_ver}/apache-tomcat-${tomcat7_ver}.tar.gz && Download_src
      src_url=https://raw.githubusercontent.com/sshadowrocket/ois/main/apache/tomcat/v${tomcat7_ver}/catalina-jmx-remote.jar && Download_src
      ;;
  esac
  ...
  if [ "${php_option}" == '1' ] || [ "${mphp_ver}" == '53' ]; then
    ...
    src_url=https://raw.githubusercontent.com/sshadowrocket/ois/main/src/argon2-${argon2_ver}.tar.gz && Download_src
    src_url=https://raw.githubusercontent.com/sshadowrocket/ois/main/src/libsodium-${libsodium_ver}.tar.gz && Download_src
    ...
    src_url=https://raw.githubusercontent.com/sshadowrocket/ois/main/src/argon2-${argon2_ver}.tar.gz && Download_src
    src_url=https://raw.githubusercontent.com/sshadowrocket/ois/main/src/libsodium-${libsodium_ver}.tar.gz && Download_src
    src_url=https://raw.githubusercontent.com/sshadowrocket/ois/main/src/libzip-${libzip_ver}.tar.gz && Download_src
